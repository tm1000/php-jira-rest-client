...
class Request implements JsonSerializable
{
	...
	public function jsonSerialize(): array
	{
		...
		if ($this->reporter) {
			$data['raiseOnBehalfOf'] =
				$this->reporter->accountId ?? $this->reporter->emailAddress;
		}
		unset($data['reporter']);

		$data['requestParticipants'] = array_map(
			static fn(Customer $customer): string => $customer->accountId ??
