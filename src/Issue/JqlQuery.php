...
class JqlQuery
{
	...
	public function addExpression(
		...
		$operator,
		$value,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
		$this->joinExpression(
	 ...
	 * @return JqlQuery
	 */
	public function addInExpression(
		$field,
		$values,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
	 ...
	 * @return JqlQuery
	 */
	public function addNotInExpression(
		$field,
		$values,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
	 ...
	 * @return JqlQuery
	 */
	public function addIsNullExpression(
		$field,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
		$this->joinExpression(
			self::quoteField($field) . ' is null',
			$logicLinkKeyword,
		);
	 ...
	 * @return JqlQuery
	 */
	public function addIsNotNullExpression(
		$field,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
		$this->joinExpression(
			self::quoteField($field) . ' is not null',
			$logicLinkKeyword,
		);
	 ...
	 * @return JqlQuery
	 */
	public function addIsEmptyExpression(
		$field,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
		$this->joinExpression(
			self::quoteField($field) . ' is empty',
			$logicLinkKeyword,
		);
	 ...
	 * @return JqlQuery
	 */
	public function addIsNotEmptyExpression(
		$field,
		$logicLinkKeyword = self::KEYWORD_AND,
	) {
		$this->joinExpression(
			self::quoteField($field) . ' is not empty',
			$logicLinkKeyword,
		);
