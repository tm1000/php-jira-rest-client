...
class MapperTest extends TestCase
{
	...
	public function testComment()
	{
		...
		$comment = $this->mapper->map(json_decode($ret), new Comment());
	...
	public function testIssueField()
	{
		...
		$issueField = $this->mapper->map(json_decode($ret), new IssueField());
		...
		$this->assertEquals(
			'lesstif@gmail.com',
			$issueField->assignee->emailAddress,
		);
	...
	public function testIssue()
	{
		...
		$issue = $this->mapper->map(json_decode($ret), new Issue());
	...
	public function testReporterField()
	{
		...
		$reporter = $this->mapper->map(json_decode($ret), new Reporter());
