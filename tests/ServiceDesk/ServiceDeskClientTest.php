...
class ServiceDeskClientTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->uut = new ServiceDeskClient($configuration, $this->logger);
    }
    ...
    public function testGetMapper(): void
    {
        ...
        self::assertInstanceOf(
            ...
            $mapper->undefinedPropertyHandler[0]
        );
        self::assertSame(
            'setUndefinedProperty',
            $mapper->undefinedPropertyHandler[1]
        );
        self::assertSame(
            DateTime::class,
            $mapper->classMap['\\' . DateTimeInterface::class]
        );
    }
